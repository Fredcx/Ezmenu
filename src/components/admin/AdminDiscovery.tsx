...
import { Globe, Eye, EyeOff, Save, Loader2, Users, Store, MapPin, Image as ImageIcon, DollarSign } from 'lucide-react';
        ...
        <div className="p-6 max-w-5xl mx-auto space-y-8 animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-5 space-y-6">
                    <section className="bg-white p-8 rounded-[2.5rem] shadow-premium border border-border/40 space-y-6">
                        <h3 className="text-lg font-black uppercase italic tracking-widest text-foreground/80">Configurações de Visibilidade</h3>
